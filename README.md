...
_See code: [src/commands/schema/generate/platformevent.ts](https://github.com/salesforcecli/plugin-sobject/blob/1.4.45/src/commands/schema/generate/platformevent.ts)_
